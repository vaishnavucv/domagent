...
By default the server binds to `127.0.0.1:18792`. To change this, edit the host, port, or path in the browser extension's Options page (right-click the extension icon and select Options).
